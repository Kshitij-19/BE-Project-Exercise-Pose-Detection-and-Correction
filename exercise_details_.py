...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller, bg='#F5F5F5', name="u"):
    ...
    def change_exercise_details(self, exercise_name):
        ...
        exit_button.grid(row=6, column=1, padx=240, pady=5)
...
class MenuPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        withdraw_button = ttk.Button(button_frame,
                                    text='Biceps',
                                    command=lambda: withdraw('Biceps'),
                                    )
        withdraw_button.grid(row=0, column=0, pady=5)
        leg_button = ttk.Button(button_frame,
                               text='legs',
                               command=lambda: withdraw('legs'),
                               )
        leg_button.grid(row=0, column=1, pady=5)

        def deposit():
            controller.show_frame('DepositPage')

        deposit_button = ttk.Button(button_frame,
                                   text='Shoulder',
                                   command=lambda: withdraw('Shoulder'))
        deposit_button.grid(row=1, column=0, pady=5)
        triceps_button =ttk.Button(button_frame,
                                   text='Triceps',
                                   command=lambda: withdraw('Triceps'),
                                   )
        triceps_button.grid(row=1, column=1, pady=5)

        def balance():
            controller.show_frame('BalancePage')

        balance_button =ttk.Button(button_frame,
                                   text='Chest',
