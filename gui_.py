...
browse_button =ttk.Button(root, text="SELECT VIDEO",
                          command=guiInstance.browseFiles, style="Accent.TButton" )
browse_button.grid(row=2, column=0, pady=60, padx=10)


process_button =ttk.Button(
    root, text="PROCESS", command=on_click_process, )
